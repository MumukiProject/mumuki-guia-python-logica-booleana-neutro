...
A diferencia del `and`, `or` y `not`, el `xor` no suele estar definido en los lenguajes. :cry: Sin embargo, ahora que sabes cómo funciona, si alguna vez lo necesitas puedes definirlo a mano. :wink:

> Veamos si se entiende: define la función genérica `xor`, que tome dos booleanos y devuelva el valor de verdad correspondiente.
